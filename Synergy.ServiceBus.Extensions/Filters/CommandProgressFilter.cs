...
{
    public class CommandProgressFilter : MessageFilter<Command>
    {
        ...
        public CommandProgressFilter(ILoggerFactory loggerFactory, IProgressScopeFactory progressScopeFactory, IProgressScopeAccessor progressScopeAccessor)
        {
        ...
        public override Task<FilterExecutionResult> PreSendMessageAsync(Command message, FilterExecutionContext filterExecutionContext)
        {
        ...
        public override Task PreHandleMessageAsync(Command message, HandleOptions options, FilterExecutionContext context)
        {
